...
void mat_mul_a_T(int* dst, int* src_a, int* src_b, int a_row, int a_col, int b_row, int b_col)
{
...
int main()
{
    ...
    // mat_mul(&dst[0][0], &src_a[0][0], &src_b[0][0], 2,3,3,4);
    mat_mul_a_T(&dst[0][0], &src_a_T[0][0], &src_b[0][0], 3,2,3,4);
